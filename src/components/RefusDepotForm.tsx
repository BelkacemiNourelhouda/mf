...
type RefusDepotFormValues = z.infer<typeof refusDepotSchema>

export default function RefusDepotForm() {
    const navigate = useNavigate()
  const form = useForm<RefusDepotFormValues>({
  ...
  const onSubmit = (values: RefusDepotFormValues) => {
